				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li class="current-menu-item"><a href="Casa_CulturaII.php">Alumnos Casa Cultura II<span class="subheader">Por Votar </span></a>
								<ul>
 	...
 	<!-- Grado y grupo --> 
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Casa de la Cultura II Alumnos por votar</span>
					</div>
					<!-- ENDS title -->
...
mysql_query("SET NAMES 'UTF8'");
  $query ="SELECT Estudiante.id, Nombre,Codigo,Ap_Paterno,Ap_Materno, Urnas.voto FROM Estudiante,Sede,Urnas WHERE Sede.id=id_Sede AND Sede.id=2 AND Urnas.voto=0 AND Urnas.id_Estudiante=Estudiante.id";

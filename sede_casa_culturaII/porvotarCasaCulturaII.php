...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Por votar sede casa cultura II</title>
						...
						<ul id="nav" class="sf-menu">
                            ...
                            <li class="current-menu-item"><a href="Casa_cultura_I.php">Sede<span class="subheader">Alterna</span></a>
								<ul>
									...
									<li><a href="../sede_casa_culturaII/Casa_Cultura_I.php"><span>Casa Cultura I</span></a></li>
...
<th><font face="verdana"><b>MESA</b></font></th>
 ...
 mysql_query("SET NAMES 'UTF8'");
  $query ="SELECT Nombre,Codigo,Ap_Paterno,Ap_Materno, Urnas.voto FROM Estudiante, Sede, Urnas WHERE Sede.id=id_Sede AND Sede.id=2 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=0";

...
<html>
	<head>
		...
		<title>EED | Lic. Historia del arte</title>
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="historia_arte.php">Alumnos<span class="subheader">Historia del Arte</span></a>
								<ul>
									
									<li><a href="porvotarHistoria_arte.php"><span>Por Votar(Historia del arte)</span></a></li>
...
<li><a href="alumnos.php">Grado y Grupo<span class="subheader">Historia del Arte</span></a>
								<ul>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Historia del Arte</span>
					</div>
					<!-- ENDS title -->
...
mysql_query("SET NAMES 'UTF8'");
  ...
  WHERE Licenciatura.id=id_Licenciatura AND Licenciatura.id=6 AND Urnas.id_Estudiante=Estudiante.id";

...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Lic. Medico Cirujano y Partero</title>
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="Casa_CulturaI.php">Alumnos<span class="subheader">votantes</span></a>
								<ul>
									...
									<li><a href="porvotarMedico_cirujano.php"><span>Por Votar(Medico Ciirujano)</span></a></li>
...
<li><a href="alumnos.php">Grado y Grupo<span class="subheader">Aulas</span></a>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. M&eacute;dico Cirujano y Partero</span>
					</div>
					<!-- ENDS title -->

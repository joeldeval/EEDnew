...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Por votar Lic. Medico Cirujano y Partero</title>
     ...
     ?><div class="top-search">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="../alumnos.php">Alumnos<span class="subheader">votantes</span></a>
								<ul>
									...
									<li><a href="votaronMedico_cirujano.php"><span>Votaron(Medico Cirujano)</span></a></li>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Salud Publica Alumnos por votar</span>
					</div>
					<!-- ENDS title -->
...
<th><font face="verdana"><b>MESA</b></font></th>
 ...
 mysql_query("SET NAMES 'UTF8'");
  $query ="SELECT Nombre,Codigo,Ap_Paterno,Ap_Materno,Urnas.voto FROM Estudiante,Licenciatura,Urnas WHERE Licenciatura.id=id_Licenciatura AND Licenciatura.id=2 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=0";

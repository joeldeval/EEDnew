...
<html>
	...
	<link rel="shortcut icon" href="favicon.png" />
		<meta charset="utf-8">
		<title>EED | Por votar Casa cultura I</title>
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li class="current-menu-item"><a href="porvotarCasaCulturaI.php">Alumnos Casa Cultura I<span class="subheader">
							Aún no han Votado</span></a>
								<ul>
                            ...
                            <li><a href="../sede.php">Sede<span class="subheader">Casa Cultura I</span></a>
								<ul>
								    ...
								    <li><a href="Casa_CulturaI.php"><span>Casa Cultura I</span></a></li>
 ...
 mysql_query("SET NAMES 'UTF8'");
  $query ="SELECT Estudiante.id, Nombre,Codigo,Ap_Paterno,Ap_Materno, Urnas.voto FROM Estudiante,Sede,Urnas 
  WHERE Sede.id=id_Sede AND Sede.id=1 AND Urnas.voto=0 AND Urnas.id_Estudiante=Estudiante.id";

				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li class="current-menu-item"><a href="votaronCasaCulturaI.php">Alumnos Casa Cultura I<span class="subheader">Ya Votaron </span></a>
								<ul>
...
mysql_query("SET NAMES 'UTF8'");
   $query ="SELECT Nombre,Codigo,Ap_Paterno,Ap_Materno,Urnas.voto FROM Estudiante,Sede,Urnas WHERE Sede.id=id_Sede AND Sede.id=1 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=1";

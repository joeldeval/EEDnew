...
<html>
						...
						<ul id="nav" class="sf-menu">
							...
							<li  class="current-menu-item"><a href="alumnos.php">Alumnos<span class="subheader">Todas Las Sedes</span></a>
								<ul>
									...
									<li><a href="votaron.php"><span>Han Votado</span></a></li>
 ...
 mysql_query("SET NAMES 'UTF8'");
  $query ="SELECT Nombre,Codigo,Ap_Paterno,Ap_Materno, Urnas.voto FROM Estudiante, Urnas WHERE 
   Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=0";
  ...
  $sinvotar = mysql_fetch_row($result2);
   echo "<th><b> TOTAL Alumnos que aún no votan: " . $sinvotar[0] ."</b></th>";

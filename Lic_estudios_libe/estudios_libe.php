...
<html>
	<head>
		...
		<title>EED | Estudios Liberales</title>
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="estudios_libe.php">Alumnos<span class="subheader">Estudios Liberales</span></a>
								<ul>
									
									<li><a href="porvotarEstudiosliberales.php"><span>Por Votar(Estudios Liberales)</span></a></li>
									<li><a href="votaronEstudiosliberales.php"><span>Votaron(Estudios Liberales)</span></a></li>
...
<li><a href="alumnos.php">Grado y Grupo<span class="subheader">Estudios liberales</span></a>
								<ul>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Estudios Liberales</span>
					</div>
					<!-- ENDS title -->
...
mysql_query("SET NAMES 'UTF8'");
  ...
  WHERE Licenciatura.id=id_Licenciatura AND Licenciatura.id=8 AND Urnas.id_Estudiante=Estudiante.id";

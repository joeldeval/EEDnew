...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Por votar Lic. Estudios Liberales</title>
     ...
     ?><div class="top-search">
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="estudios_libe.php">Alumnos<span class="subheader">votantes</span></a>
								<ul>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Estudios Liberales Alumnos por votar</span>
					</div>
					<!-- ENDS title -->
...
<th><font face="verdana"><b>MESA</b></font></th>
 ...
 mysql_query("SET NAMES 'UTF8'");
  ...
  AND Licenciatura.id=8 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=0";

...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Votaron Lic. Estudios Liberales </title>
     ...
     ?><div class="top-search">
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Estudios Liberales Alumnos votaron</span>
					</div>
					<!-- ENDS title -->
...
<th><font face="verdana"><b>MESA</b></font></th>
  ...
  Licenciatura.id=8 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=1";

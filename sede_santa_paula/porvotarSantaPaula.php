...
<html>
	...
	<link rel="shortcut icon" href="../favicon.png" />
		<meta charset="utf-8">
		<title>EED | Por votar Santa Paula</title>
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li class="current-menu-item"><a href="porvotarSantaPaula.php">Alumnos<span class="subheader">Por Votar(Santa Paula)</span></a>
								<ul>
                            	...
                            	<!-- sedes -->
                            <li ><a href="../sede.php">Sede<span class="subheader">Santa Paula</span></a>
								<ul>
                                    ...
                                    <li><a href="../sede_sillitas/Sillitas.php"><span>Sillitas</span></a></li>
									 <li><a href="Santa_Paula.php"><span>Santa Paula</span></a></li>
 	...
 	<!-- Grado y grupo --> 
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Santa Paula Alumnos por votar</span>
					</div>
					<!-- ENDS title -->
...
mysql_query("SET NAMES 'UTF8'");
  $query ="SELECT Estudiante.id, Nombre,Codigo,Ap_Paterno,Ap_Materno, Urnas.voto FROM Estudiante,Sede,Urnas WHERE Sede.id=id_Sede AND Sede.id=4 AND Urnas.voto=0 AND Urnas.id_Estudiante=Estudiante.id";

...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Por votar sede Santa Paula</title>
...
<th><font face="verdana"><b>MESA</b></font></th>
 ...
 mysql_query("SET NAMES 'UTF8'");
  $query ="SELECT Nombre,Codigo,Ap_Paterno,Ap_Materno, Urnas.voto FROM Estudiante, Sede, Urnas WHERE Sede.id=id_Sede AND Sede.id=4 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=0";

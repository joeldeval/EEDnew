...
<html>
	...
	<link rel="shortcut icon" href="../favicon.png" />
		<meta charset="utf-8">
		<title>EED | votaron Santa Paula</title>
     ...
     ?><div class="top-search">
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li class="current-menu-item"><a href="votaronSantaPaula.php">Alumnos<span class="subheader">Votaron(Santa Paula)</span></a>
								<ul>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Alumnos Que votaron(Santa Paula)</span>
					</div>
					<!-- ENDS title -->
...
<th><font face="verdana"><b>VOTO</b></font></th>
  ...
  $query ="SELECT Nombre,Codigo,Ap_Paterno,Ap_Materno,Urnas.voto FROM Estudiante,Sede,Urnas WHERE Sede.id=id_Sede AND Sede.id=4 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=1";

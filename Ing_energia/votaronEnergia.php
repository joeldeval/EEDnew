...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Votaron Ing. Energia</title>
     ...
     ?><div class="top-search">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="../energia.php">Alumnos<span class="subheader">votantes</span></a>
								<ul>
									...
									<li><a href="porvotarEnergia.php"><span>Por Votar(Nanotecnologia)</span></a></li>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Ing. Energ&iacute;a Alumnos votaron</span>
					</div>
					<!-- ENDS title -->
...
<th><font face="verdana"><b>MESA</b></font></th>
  ...
  Licenciatura.id=4 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=1";

				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="abogado.php">Alumnos<span class="subheader">Abogado</span></a>
								<ul>
									
									<li><a href="porvotarAbogado.php"><span>Por Votar(Abogado)</span></a></li>
									<li><a href="votaronAbogado.php"><span>Votaron(Abogado)</span></a></li>
...
<li><a href="alumnos.php">Grado y Grupo<span class="subheader">Abogado</span></a>
								<ul>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Abogado</span>
					</div>
					<!-- ENDS title -->
...
mysql_query("SET NAMES 'UTF8'");
  ...
  WHERE Licenciatura.id=id_Licenciatura AND Licenciatura.id=12 AND Urnas.id_Estudiante=Estudiante.id";

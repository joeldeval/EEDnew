...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Por votar Lic. Abogado</title>
     ...
     ?><div class="top-search">
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Abogado Alumnos por votar</span>
					</div>
					<!-- ENDS title -->
...
<th><font face="verdana"><b>MESA</b></font></th>
 ...
 mysql_query("SET NAMES 'UTF8'");
  ...
  AND Licenciatura.id=12 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=0";

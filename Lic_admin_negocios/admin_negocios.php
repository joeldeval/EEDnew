...
<html>
	<head>
		...
		<title>EED | Lic. Administracion de Negocios</title>
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="admin_negocios.php">Alumnos<span class="subheader">Administraci&oacute;n de Negocios</span></a>
								<ul>
									
									<li><a href="porvotarAdmin_negocios.php"><span>Por Votar(Administraci&oacute;n de Negocios)</span></a></li>
									<li><a href="votaronAdmin_negocios.php"><span>Votaron(Administraci&oacute;n de Negocios)</span></a></li>
...
<li><a href="alumnos.php">Grado y Grupo<span class="subheader">Administraci&oacute;n de Negocios</span></a>
								<ul>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Administraci&oacute;n de Negocios</span>
					</div>
					<!-- ENDS title -->
...
mysql_query("SET NAMES 'UTF8'");
  ...
  WHERE Licenciatura.id=id_Licenciatura AND Licenciatura.id=11 AND Urnas.id_Estudiante=Estudiante.id";

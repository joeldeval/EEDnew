...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Votaron Lic. Contaduria Publica</title>
     ...
     ?><div class="top-search">
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Contadur&iacute;a Publica Alumnos votaron</span>
					</div>
					<!-- ENDS title -->
...
<th><font face="verdana"><b>MESA</b></font></th>
  ...
  Licenciatura.id=10 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=1";

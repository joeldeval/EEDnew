...
<html>
	<head>
		...
		<title>EED | Lic. Contaduria Publica</title>
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="contaduria.php">Alumnos<span class="subheader">Contadur&iacute;a Publica</span></a>
								<ul>
									
									<li><a href="porvotarContaduria.php"><span>Por Votar(Contadur&iacute;a Publica)</span></a></li>
									<li><a href="votaronContaduria.php"><span>Votaron(Contadur&iacute;a Publica)</span></a></li>
...
<li><a href="alumnos.php">Grado y Grupo<span class="subheader">Contadur&iacute;a Publica</span></a>
								<ul>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Contadur&iacute;a Publica</span>
					</div>
					<!-- ENDS title -->
...
mysql_query("SET NAMES 'UTF8'");
  ...
  WHERE Licenciatura.id=id_Licenciatura AND Licenciatura.id=10 AND Urnas.id_Estudiante=Estudiante.id";

...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Por votar Lic. Contaduria Publica</title>
     ...
     ?><div class="top-search">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="contaduria.php">Alumnos<span class="subheader">Contadur&iacute;a Publica</span></a>
								<ul>
									...
									<li><a href="votaronCienciasContaduria.php"><span>Votaron(Contadur&iacute;a Publica)</span></a></li>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Contadur&iacute;a Publica Alumnos por votar</span>
					</div>
					<!-- ENDS title -->
...
<th><font face="verdana"><b>MESA</b></font></th>
 ...
 mysql_query("SET NAMES 'UTF8'");
  ...
  AND Licenciatura.id=10 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=0";

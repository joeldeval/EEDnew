...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Por votar Lic. Gerontologia</title>
     ...
     ?><div class="top-search">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="../gerontologia.php">Alumnos<span class="subheader">votantes</span></a>
								<ul>
									...
									<li><a href="votaronGerontologia.php"><span>Votaron(Gerontologia)</span></a></li>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Gerontolog&iacute;a Alumnos por votar</span>
					</div>
					<!-- ENDS title -->
...
<th><font face="verdana"><b>MESA</b></font></th>
 ...
 mysql_query("SET NAMES 'UTF8'");
  ...
  Licenciatura.id=7 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=0";

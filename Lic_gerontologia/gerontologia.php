...
<html>
	<head>
		...
		<title>EED | Lic. Gerontologia</title>
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="gerontologia.php">Alumnos<span class="subheader">Gerontolog&iacute;a</span></a>
								<ul>
									
									<li><a href="porvotarGerontologia.php"><span>Por Votar(Gerontolog&iacute;a)</span></a></li>
									<li><a href="votaronGerontologia.php"><span>Votaron(Gerontolog&iacute;a)</span></a></li>
...
<li><a href="alumnos.php">Grado y Grupo<span class="subheader">Gerontolog&iacute;a</span></a>
								<ul>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Gerontolog&iacute;a</span>
					</div>
					<!-- ENDS title -->
...
mysql_query("SET NAMES 'UTF8'");
  ...
  WHERE Licenciatura.id=id_Licenciatura AND Licenciatura.id=7 AND Urnas.id_Estudiante=Estudiante.id";

...
<html>
	<head>
		...
		<title>EED | Lic. Diseño de Artesanias</title>
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="diseño_artesania.php">Alumnos<span class="subheader">Diseño de Artesanias</span></a>
								<ul>
									
									<li><a href="porvotarDiseñoartesania.php"><span>Por Votar(Diseño de Artesanias)</span></a></li>
									<li><a href="votaronDiseñoartesania.php"><span>Votaron(Diseño de Artesanias)</span></a></li>
...
<li><a href="alumnos.php">Grado y Grupo<span class="subheader">Ciencias Computacionales</span></a>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Diseño de Artesan&iacute;as</span>
					</div>
					<!-- ENDS title -->
...
mysql_query("SET NAMES 'UTF8'");
  ...
  WHERE Licenciatura.id=id_Licenciatura AND Licenciatura.id=9 AND Urnas.id_Estudiante=Estudiante.id";

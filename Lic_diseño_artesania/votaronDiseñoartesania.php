...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Votaron Lic. Diseño de Artesanias</title>
     ...
     ?><div class="top-search">
				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="diseño_artesania.php">Alumnos<span class="subheader">votantes</span></a>
								<ul>
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Lic. Diseño de Artesan&iacute:as Alumnos votaron</span>
					</div>
					<!-- ENDS title -->
...
<th><font face="verdana"><b>MESA</b></font></th>
  ...
  Licenciatura.id=9 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=1";

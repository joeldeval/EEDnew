...
<html>
	<head>
		<meta charset="utf-8">
		<title>EED | Por votar Lic. Salud Publica</title>
...
<th><font face="verdana"><b>MESA</b></font></th>
 ...
 mysql_query("SET NAMES 'UTF8'");
  $query ="SELECT Nombre,Codigo,Ap_Paterno,Ap_Materno,Urnas.voto FROM Estudiante,Licenciatura,Urnas WHERE Licenciatura.id=id_Licenciatura AND Licenciatura.id=1 AND Urnas.id_Estudiante=Estudiante.id AND Urnas.voto=0";
